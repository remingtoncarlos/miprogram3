...
public class Metodos {
	private int vr,m,n,matricula; String op;
	private int ton;
	...
	public int menu(int x) {
		...
		catch(Exception e) { System.out.println(" **************** Solo enteros entre 1 y 4 *********"); }
		return x;
	}//fin MENU
...
try {	matricula=Integer.valueOf(matricula);
		if(matricula>100 && matricula<10000) {	
		   ...
		   {System.out.print("--------------------- Ingres No. matrícula entre 100 y 9999 ! ------ \n");
		    res=false;}
									//System.out.print("RES else: "+(res));
		                            //  leer.nextLine();//System.out.println("\nDigite el número de matricula: " );
}catch(Exception s) { System.out.println(" **************** Solo Números enteros  *********"); }
		...
		System.out.print("\n Ingrese los dias del alquiler hasta 365: ");
		    ...
		    if(dias>365) {System.out.print("--**-- Tiempo máximo del contrato es de 1 a 365 días: --**--");   }
